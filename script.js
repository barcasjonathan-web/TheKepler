...
//variants:[{color:"#",size:"#",stock:#}]},//
  ...
  {id:005, name:"Golden Vertex Sunglasses", category:"Accesorios", price:6.00, image:"products/005gafas01.png",
   ...
   gallery:["products/005gafas01.png",
            ...
            "products/005gafas04.png",
            "products/005gafas05.png",
            "products/005gafas06.png"],
   variants:[{color:"Negro",size:"Universal",stock:2}]},

  {id:006, name:"Stylized Sunglasses", category:"Accesorios", price:6.00, image:"products/006gafas01.png", 
   description:"Montura gruesa en color negro con acentos metálicos, lentes oscuros de estilo angular y futurista.",
   gallery:["products/006gafas01.png",
            "products/006gafas02.png",
            "products/006gafas03.png",
            "products/006gafas04.png",
            "products/006gafas05.png",
            "products/006gafas06.png"],
   variants:[{color:"Negro c/ Manchas Rojas",size:"Universal",stock:1},
            {color:"Negro",size:"Universal",stock:2}]},

  {id:007, name:"Amiri Sandals", category: "Calzado", price:16.00, image:"products/007chancletas01.png",
   description:"Sandalias con suela negra y correa decorada con tachuelas y el logo AMIRI en relieve, diseño minimalista y lujoso.",
   gallery:["products/007chancletas01.png",
            "products/007chancletas02.png",
            "products/007chancletas03.png",
            "products/007chancletas04.png",
            "products/007chancletas05.png",
            "products/007chancletas06.png"],
   variants:[{color:"Negro",size:"39",stock:2},
             {color:"Negro",size:"42",stock:2},
             {color:"Negro",size:"43",stock:2},
             {color:"Blanco",size:"40",stock:2},
             {color:"Blanco",size:"42",stock:2},
             {color:"Blanco",size:"43",stock:2},
             {color:"Rojo",size:"42",stock:2},
             {color:"Rojo",size:"43",stock:2},
             {color:"Rojo",size:"44",stock:2},
            ]},

  {id:008, name:" Ventilador Keeva FB‑45A", category:"Hogar", price:60.00, image:"products/008ventilador01.png",
   description:"Ventilador de pared de 18 pulgadas con motor de cobre, control remoto y oscilación automática de 90°, diseñado para ofrecer un flujo de aire potente y confiable en espacios interiores.",
   gallery:["products/008ventilador01.png",
            "products/008ventilador02.png",
            "products/008ventilador03.png",
